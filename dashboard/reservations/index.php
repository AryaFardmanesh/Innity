...
$roomsModels = RoomRepository::getAll(
	$currentPage,
	PAGINATION_LIMIT,
	null,
	null,
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-12 col-md-2 p-0">
				<?php
					$AsideBarSetting_ActiveLink = "reservations";
			...
			<div class="col-12 col-md-10">
				<div class="container py-2">
					...
					<section class="dashboard-accounts py-5">
						<div class="container">
							<h4 class="mb-4 fw-bold">The Reservations Management</h4>
								...
								<table class="table table-hover align-middle mb-3">
									<thead class="table-light">
										<tr class="text-center">
											...
											<th scope="col">Reserved Duration</th>
									...
									<tbody>
										...
										<tr class="text-center">
											...
											<td>$<?= $room->price * $room->reserved_for ?></td>
											<td><a href="<?= BASE_URL ?>controllers/room.php?action=cancel&id=<?= $room->id ?>&redirect=<?= BASE_URL . "dashboard/reservations/?page=" . $currentPage ?>" class="btn btn-sm btn-danger text-decoration-none">Cancel</a></td>
										</tr>
										<?php } ?>
							...
							<nav aria-label="Accounts pagination" class="d-flex justify-content-center">
								<?php
									$pageCount = RoomServices::getPageCount(null, null, true);
