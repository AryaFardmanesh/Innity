...
$hotelsModels = HotelRepository::getAll($currentPage);
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-12 col-md-2 p-0">
				<?php
					$AsideBarSetting_ActiveLink = "hotels";
			...
			<div class="col-12 col-md-10">
				<div class="container py-2">
					...
					<section class="dashboard-accounts py-5">
						<div class="container">
							<h4 class="mb-4 fw-bold">The Hotels Management</h4>
								...
								<table class="table table-hover align-middle mb-3">
									...
									<tbody>
										...
										<tr class="text-center">
											<th scope="row"><?= $isn ?></th>
											<td><?= $name ?></td>
											<td><span class="badge bg-dark"><?= $location ?></span></td>
											<td><span class="badge <?= $statusColor ?>"><?= $status ?></span></td>
											<td><a href="<?= BASE_URL ?>hotel/?id=<?= $id ?>" class="link-primary text-decoration-none">See</a></td>
											<td><a href="<?= BASE_URL ?>controllers/hotel.php?action=remove&id=<?= $id ?>&redirect=<?= BASE_URL ?>dashboard/hotels/?page=<?= $currentPage ?>" class="btn btn-sm btn-danger text-decoration-none">Remove</a></td>
											<td><a href="<?= BASE_URL ?>controllers/hotel.php?action=undo&id=<?= $id ?>&redirect=<?= BASE_URL ?>dashboard/hotels/?page=<?= $currentPage ?>" class="btn btn-sm btn-success text-decoration-none <?= $undoLock ?>">Undo</a></td>
										</tr>
										<?php } ?>
